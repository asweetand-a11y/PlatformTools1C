		...
		return [
			...
			this.createTreeItem(
				...
				[
					...
					this.createTreeItem(
						...
						vscode.TreeItemCollapsibleState.None,
						{
							command: '1c-platform-tools.configuration.updateFromSrcWithCommit',
							title: getUpdateConfigurationFromSrcWithCommitCommandName().title,
						}
					),
					this.createTreeItem(
					...
					this.createTreeItem(
						'🔄 Выгрузить обновление в src/cf',
						TreeItemType.Task,
						vscode.TreeItemCollapsibleState.None,
						{
							command: '1c-platform-tools.configuration.dumpUpdateToSrc',
							title: getDumpUpdateConfigurationToSrcCommandName().title,
						}
					),
					this.createTreeItem(
						'📤 Выгрузить в 1Cv8.cf',
			...
			this.createTreeItem(
				...
				[
					...
					this.createTreeItem(
						'🔄 Выгрузить обновление в src/cfe',
						TreeItemType.Task,
						vscode.TreeItemCollapsibleState.None,
						{
							command: '1c-platform-tools.extensions.dumpUpdateToSrc',
							title: getDumpUpdateExtensionToSrcCommandName().title,
						}
					),
					this.createTreeItem(
						'🔄 Обновить из src/cfe',
						...
						vscode.TreeItemCollapsibleState.None,
						{
							command: '1c-platform-tools.extensions.updateFromSrcWithCommit',
							title: getUpdateExtensionFromSrcWithCommitCommandName().title,
						}
					),
					this.createTreeItem(
						'📤 Выгрузить в *.cfe',
