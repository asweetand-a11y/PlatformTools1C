...
/**
 * Получить название и заголовок для команды обновления конфигурации из src/cf с использованием Commit.txt
 */
export function getUpdateConfigurationFromSrcWithCommitCommandName(): CommandNameAndTitle {
	return {
		name: 'Обновление конфигурации с Commit.txt',
...
/**
 * Получить название и заголовок для команды выгрузки обновления конфигурации в src/cf
 */
export function getDumpUpdateConfigurationToSrcCommandName(): CommandNameAndTitle {
	return {
		name: 'Выгрузить обновление в src/cf',
...
/**
 * Получить название и заголовок для команды выгрузки обновления расширений в src/cfe
 */
export function getDumpUpdateExtensionToSrcCommandName(): CommandNameAndTitle {
	return {
		name: 'Выгрузить обновление расширений в src/cfe',
		title: 'Выгрузить обновление расширений в src/cfe'
	};
}

/**
 * Получить название и заголовок для команды обновления расширений из src/cfe с использованием Commit.txt
 */
export function getUpdateExtensionFromSrcWithCommitCommandName(): CommandNameAndTitle {
	return {
		name: 'Обновить расширения из src/cfe',
